...
# The first version he shows you picks a random number between 1 and a provided maximum number and offers you a given number of attempts to guess it.
  ...
  loop do
    ...
    guess = input.to_i
			...
			if 	attempts >= max_attempts
				puts "Wrong. Sorry, you've used up all of your guesses"
				break
				end
