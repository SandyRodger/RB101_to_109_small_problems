...
# For example, the 100th Fibonacci number is 354,224,848,179,261,915,075 -- that is enormous,
...
# 1. write a method that will calculate the fibonacci sequence until it grows to the specified length.
...
def find_fibonacci_index_by_length(number)
	...
	loop do
		...
		break if fib_array[-1].to_s.size == number
	end
